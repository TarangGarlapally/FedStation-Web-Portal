...
export default function NewProject(props) {
    ...
    const stage4 = <div>
                        ...
                        <div className="project-type">
                            ...
                            Start recieving at &nbsp; &nbsp; <select id = "startAtTime" name = "startAtTime" className="new-project-input smallInput" onChange={(e)=>{setStartTime(parseInt(e.target.value)); setProjectObj({...projectObj, startAtTime: startTime.toString()})}} value = {startTime} required>
                                {hourDropdown()}
                            ...
                            <br /><br />
                            Trigger once every &nbsp; <select id = "triggerEvery" name = "triggerEvery" className="new-project-input smallInput" required onChange={(e)=>{setProjectObj({...projectObj, triggerEvery: parseInt(e.target.value)})}}>
